...
Log at these points:
1. **On invocation** — which plan is being broken into tasks (feature name)
2. **After task generation** — total task count, phase count, brief list of task titles
3. **After tasks.md created** — path to tasks.md
