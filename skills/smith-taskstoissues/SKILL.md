...
Log at these points:
1. **On invocation** — which tasks.md is being converted (feature name)
2. **After issues created** — count of GitHub Issues created, issue numbers
