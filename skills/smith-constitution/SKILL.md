...
Log at these points:
1. **On invocation** — what is being changed (new constitution or amendment)
2. **After amendments applied** — summary of principles added, modified, or removed
3. **After propagation** — which templates or artifacts were updated as a result
